/*
-------------------------------------------------------------------------------------------------
        NAME: AG_SyncWorkload.sql
 MODIFIED BY: Sal Young
       EMAIL: saleyoun@yahoo.com
 DESCRIPTION: USE THIS QUERY TO VIEW CURRENT WORKLOAD OF AG
-------------------------------------------------------------------------------------------------
...
SELECT GETDATE() [collection_time]
     ...
     , dr_state.log_send_queue_size [log_send_queue_size]
     , dr_state.redo_queue_size [redo_queue_size]
     , dr_state.log_send_rate [log_send_rate]
     , dr_state.redo_rate [redo_rate]
